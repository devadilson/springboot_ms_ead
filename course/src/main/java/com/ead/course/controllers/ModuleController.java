...
public class ModuleController {
    ...
    public ResponseEntity<Object> saveModule(@PathVariable(value = "courseId") UUID courseId, @RequestBody @Valid ModuleDto moduleDto) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED).body(moduleService);
    }
    ...
    public ResponseEntity<Page<ModuleModel>> getAllModules(@PathVariable(value = "courseId") UUID courseId,
        ...
        return ResponseEntity.status(HttpStatus.OK).body(moduleService.findAllCourse(SpecificationTemplate.moduleCourseId(courseId).and(spec), pageable));
    }
